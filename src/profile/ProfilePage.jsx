...
import { faAt, faIdCard, faGlobe, faLanguage, faGraduationCap, faCommentDots, faUser } from '@fortawesome/free-solid-svg-icons';
    ...
    <div className="profile-page">
      {isLoadingProfile ? (
        ...
        <>
          <div
            className={classNames(
              'profile-page-bg-banner d-md-block align-items-center h-100 w-100',
          ...
          >
            <div className="w-100 p-0">
              ...
              >
                ...
                >
                  <div className="m-0 mb-3 profile-field-card">
                    <div className="row m-0 pb-1.5 align-items-center">
                      <p data-hj-suppress className="h5 font-weight-bold m-0 label-with-icon">
